        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Ханаан</h1>
                    <p>Ханаан - это производство и реализация пищевых полуфабрикатов.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(914)-755-19-17</p>
