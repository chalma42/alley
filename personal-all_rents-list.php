		...
		<div class="container">
			<h1>
				...
				<div class="types_list">
					<a href="personal-all_rents-list.php" class="list_type active">
...
<rect width="19" height="2" fill="#888888"/>
					...
					<a href="personal-all_rents-block.php" class="block_type">
...
<rect width="4.63636" height="7" fill="black"/>
					...
					<input type="text" name="" placeholder="Введите название арендатора">
				</div>
				<div class="add_new">
	...
	<section class="all_rents_page_list personal">
		<div class="container">
			...
			<div class="all_rents_page_list_wrapper">
				...
				<table>
					...
					<tbody>
						<tr>
							<td>1</td>
							<td><div class="logo_item"><img src="img/personal/m_logo.png"></div></td>
							<td>М-Видео</td>
							<td>Константинопольский<br>Константин<br> Константинович</td>
							<td>+7 906 325 65 61</td>
							<td>Текущий</td>
							<td class="actions">
								<a href="personal-rent.php"><img src="img/personal/edit.png"></a>
								<a href=""><img src="img/personal/del.png"></a>
							</td>
						</tr>
						<tr>
							<td>2</td>
							<td><div class="logo_item"><img src="img/personal/dm_logo.png"></div></td>
							<td>Детский мир</td>
						...
						<tr>
							<td>3</td>
							<td><div class="logo_item"><img src="img/personal/hm_logo.png"></div></td>
							<td>H&M</td>
						...
						<tr>
							<td>4</td>
							<td><div class="logo_item"><img src="img/personal/ber_logo.png"></div></td>
							<td>Bershka</td>
						...
						<tr>
							<td>5</td>
							<td><div class="logo_item"><img src="img/personal/terra_logo.png"></div></td>
							<td>Terranova</td>
						...
						<tr>
							<td>6</td>
							<td><div class="logo_item"><img src="img/personal/mts_logo.png"></div></td>
							<td>М-Видео</td>
						...
						<tr>
							<td>7</td>
							<td><div class="logo_item"><img src="img/personal/sv_logo.png"></div></td>
							<td>Детский мир</td>
						...
						<tr>
							<td>8</td>
							<td><div class="logo_item"><img src="img/personal/u_logo.png"></div></td>
							<td>H&M</td>
						...
						<tr>
							<td>9</td>
							<td><div class="logo_item"><img src="img/personal/big_logo.png"></div></td>
							<td>Bershka</td>
						...
						<tr>
							<td>10</td>
							<td><div class="logo_item"><img src="img/personal/avo_logo.png"></div></td>
							<td>Terranova</td>
			...
			<div class="show_more_items">
				<a href="">Показать еще 25 арендаторов</a>
			</div>
		</div>
	</section>
