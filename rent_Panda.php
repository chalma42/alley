    ...
    <section class="bread" style="padding-top: 26px;">
        <div class="container">
            <ul>
                ...
                <li><a href="#">Панда, сеть зоомаркетов</a></li>
            </ul>
        </div>
    </section>
    <!-- /Bread -->
    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/Panda_back.jpg">
                <!--Главная фотка-->
                <div class="rent_page_logo">
                    <img src="img1/Panda_Logo.png">
                    <!--Логотип-->
                </div>
            </div>
        </div>
        <div class="container ">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Панда, сеть зоомаркетов</h1>
                    <p>"Панда" - сеть зоомаркетов на Сахалине, которая заботится о том, чтобы ваше общение с любимыми питомцами было радостным и безоблачным.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)30-15-55</p>
