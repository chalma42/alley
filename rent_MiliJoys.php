    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/MiliJoys_Back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">MiLi JOYS</h1>
                    <p>Милые подарки для любимых. Корейская косметика, аксессуары, приятные мелочи</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(9621)29-60-00</p>
