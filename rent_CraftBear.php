    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/CRAFT BEER_Back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">CRAFT BEER</h1>
                    <p>Крафт Бир - это большой выбор разливного и бутылочного пива производства Японии, Кореи, Англии, Германии, Чехии, Бельгии.</p>
                    <p>Закуски, морепродукты и снэки.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)63-64-44</p>
            ...
            <div class="rent_page_poster _anim-items">
                ...
                <div class="swiper-container _anim-items">
