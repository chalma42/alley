    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/ChidrenLand_back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Детский Мир</h1>
                    <p>Группа компаний "Детский мир" является мультиформатным оператором розничной торговли, одним из лидеров в сегменте детских товаров в России, объединяющим национальную розничную сеть магазинов "Детский мир", сети магазинов ELC и ABC,
                        сеть товаров для животных "Зоозавр". Бренд "Детский мир", которому в 2018 году исполнилось 71 год, является наиболее узнаваемым среди торговых сетей детских товаров. Сеть магазинов работает в среднем ценовом сегменте. Целевой аудиторией
                        компании являются семьи со средними доходами, к которым относится большинство посетителей торговых центров. Современный супермаркет "Детский мир" включает около 20-30 тыс. наименований товаров детского ассортимента: игрушки, одежда
                        и обувь, товары для новорожденных, канцелярские товары, наборы для творчества, товары для активного отдыха, автокресла, мебель.</p>
                    <p>
                        <ul>
                ...
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(905)747-99-03</p>
