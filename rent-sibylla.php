    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/Sibylla_back.png">
                <!--Главная фотка-->
                <div class="rent_page_logo">
                    <img src="img1/Sibylla_Logo.png">
                    <!--Логотип-->
                </div>
            </div>
        </div>
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">SIBYLLA</h1>
                    <p>Кафе быстрого питания - Сибилла.</p>
                    <p>Хот-доги, бургеры, кофе с собой.</p>
                    <p>Настоящие французские и датские хот-доги с оригинальными сосисками на любой вкус, пирожные и многое другое.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)30-62-63</p>
