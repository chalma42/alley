    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/StaffBar_Back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">STAFF BAR</h1>
                    <p>Тот самый Staff Bar , только в ТРЦ «Аллея» . Небольшой бар с незатейливым меню , в котором не только взрослый , но и самый юный гость сможет найти напиток по вкусу .</p>
                    <p>Авторские коктейли , классические коктейли , сезонные предложение и многое другое специально для вас </p>
                </div>
