	...
	<section class="bread" style="padding-top: 26px;">
		<div class="container">
			<ul>
				...
				<li><a href="all_rents.html">Все арендаторы</a></li>
				<li><a href="#">Glam Queen</a></li>
			</ul>
		</div>
	</section>
	<!-- /Bread -->
	...
	<section class="rent_page">
		<div class="rent_page_main">
			<div class="container _anim-items _anim-no-hide">
				<img src="img1/Glam_Queen_img_1.png"> <!--Главная фотка-->
				<div class="rent_page_logo">
					<img src="img1/Logo_Glam_Queen.png"> <!--Логотип-->
				</div>
			</div>
		</div>
		<div class="container">
			<div class="rent_page_wrapper _anim-items flex">
				<div class="rent_page_desc">
					<h1 class="rent_page_title">Магазин корейской косметики "Glam Queen" </h1>
					<p>Glam Queen - магазин, в котором вы найдёте оригинальную люксовую косметику из Кореи.</p>
						<p>Корейская косметика уже давно доказала свою эффективность, поэтому все больше женщин выбирают именно азиатские бренды.</p>
						<p>Каждый из представленных в магазине продуктов обладает регенеративными и омолаживающими свойствами. А широкий ассортимент товаров дает возможность каждой покупательнице найти что-то подходящее.</p>
					<ul>
				...
				<div class="rent_page_contacts">
					...
					<p class="phone">8 900‒660‒2022</p>
					<p class="time">с 10:00 до 21:00</p>
				</div>
			</div>
			<!--Ниже галерея картинок-->
			<section class="rent_page_gallery">
				<img src="img1/Glam_Queen_img_2.png" width="24%">
				<img src="img1/Glam_Queen_img_3.png" width="24%">
				<img src="img1/Glam_Queen_img_4.png" width="24%">
				<img src="img1/Glam_Queen_img_5.png" width="24%">
			</section>
			<br>
			<br>
			<div class="rent_page_poster _anim-items">
				<div class="rent_page_poster_title">
					...
					<a href="poster.html" class="all_events">Все события</a>
