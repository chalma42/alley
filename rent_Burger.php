        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">BEEF BURGER</h1>
                    <p>Бургерная Beef Burger открыла свои двери 26.11.2017, на момент открытия в меню было 4 бургера и уже спустя месяц пополнили меню, на сегодняшний день в меню 8 бургеров, 6 закусок, 2 салата, авторские лимонады и натуральные морсы. Мы
                        считаем, что настоящий бургер может быть только с говяжьей котлетой и нас поддержали 50 553 раза. Именно такое количество наших бургеров мы выпустили за период своей работы.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)25-52-49</p>
