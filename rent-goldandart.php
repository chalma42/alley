	...
	<section class="rent_page">
		<div class="rent_page_main">
			<div class="container _anim-items _anim-no-hide">
				<img src="img1/Gold_and_art_img_1.png"> <!--Главная фотка-->
				<div class="rent_page_logo">
					<img src="img1/Logo_Gold_and_art.png"> <!--Логотип-->
				</div>
			</div>
		</div>
		<div class="container">
			<div class="rent_page_wrapper _anim-items flex">
				<div class="rent_page_desc">
					<h1 class="rent_page_title">Магазин ювелирных изделий "Gold and Art" </h1>
					<p>Ювелирная компания "Gold&Art" была создана в 2008 году. Ее созданию предшествовал 15-ти летний опыт работы на розничном рынке ювелирных изделий.
						"Gold&Art" - является официально зарегистрированным товарным знаком.
						Магазины "Gold&Art" осуществляют розничную торговлю ювелирными изделиями из драгоценных металлов, часами российского и швейцарского производства, а также другой ювелирной продукцией.</p>
					<ul>
				...
				<div class="rent_page_contacts">
					...
					<p class="phone">8(4242) 73-70-42</p>
					<p class="time">с 10:00 до 21:00</p>
				</div>
			</div>
			<!--Ниже галерея картинок-->
			<section class="rent_page_gallery _anim-items">
				<img src="img1/Apteka_img_2.png" width="24%">
				<img src="img1/Apteka_img_3.png" width="24%">
				<img src="img1/Apteka_img_4.png" width="24%">
			</section>
			<br>
			<br>
