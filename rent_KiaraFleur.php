    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/Kiara Fleur_Back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Kiara Fleur</h1>
                    <p>Цветочная мастерская была создана 17 августа 2008 года. Руководство постоянно меняет и старается расширить ассортимент цветов и сопутствующих товаров, учитывает потребности и запросы клиентов.
                    </p>
                    <p>Компания работает с несколькими фирмами, поставляющими свежесрезанные и горшечные цветы с разных стран мира: Эквадор, Колумбия, Кения, Нидерланды, Израиль и другие, это позволяет держать качество по доступным ценам.
                    </p>
                    <p>
                        За время работы наши флористы зарекомендовали себя профессионалами в своем деле, они стараются идти в ногу со временем, учитывать модные тенденции во флористике. Составление букетов (свадебные, праздничные). Сопутствующие товары: упаковочная бумага, сувениры,
                        аксессуары, открытки.
                    </p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)29-19-35</p>
