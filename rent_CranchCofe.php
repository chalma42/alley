    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/CranchCofe_back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Crunch Cafe</h1>
                    <p>Crunch Cafe - кафе быстрого питания: нетрадационные блины, напитки, салаты.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(914)755‒46-65</p>
