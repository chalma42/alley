	...
	<section class="rent_page">
		<div class="rent_page_main">
			<div class="container _anim-items _anim-no-hide">
				<img src="img1/Svyaznoi_img_1.png"> <!--Главная фотка-->
				<div class="rent_page_logo">
					<img src="img1/Logo_svyaznoi.png"> <!--Логотип-->
				</div>
			</div>
		</div>
		<div class="container">
			<div class="rent_page_wrapper _anim-items flex">
				<div class="rent_page_desc">
					<h1 class="rent_page_title">Связной </h1>
					<p>«Сеть Связной» – крупнейшая розничная сеть в сегменте высоких технологий. У компании более четырех тысяч магазинов в 1200 городах России, более 23 тысяч продавцов-консультантов, которые обслуживают более миллиона покупателей в день.</p> 
					<p>	Ключевой фокус работы Связного – стать проводником в мир технологий для самой широкой аудитории. Достичь этой цели позволяет собственная платформа онлайн-продаж, тесное взаимодействие с вендорами и разработчиками сервисов, а также развитие собственных нишевых продуктов.
						Интеграция с производителями высоких технологий и разработчиками различных сервисов позволяет компании создавать уникальные и совершенно неожиданные возможности для клиентов. Миссия компании – сделать позитивным опыт взаимодействия человека с технологиями.</p>
					<p>
					<ul>
