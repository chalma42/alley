...
<head>
	...
	<title>Личный кабиент | Арендаторы - ТРЦ Аллея</title>
</head>
<body>
...
<rect width="4.63636" height="7" fill="black"/>
					...
					<input type="text" name="" placeholder="Введите название арендатора" value="asddesgrhty6765345346">
				</div>
				<div class="add_new">
			...
			<div class="all_rents_page_list_wrapper">
				...
				<div class="all_rents_page_items flex">
					<div class="all_rents_page_items_empty_request">
						...
						<a href="personal-all_rents-list.php">Вернуться ко всем арендаторам</a>
					</div>
