        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">STORYA</h1>
                    <p>Однажды мы решили создать историю о том, как превратить обычное пространство в чудесный парк, где всегда будет тепло и уютно. Но не тут то было, дожди и бури стали нам мешать!</p>
                    <p>И тогда на помощь пришёл добрый человечек по имени ЯРИ.</p>
                    <p>Он объединил всю семью, а потом каждому дал возможность написать свою историю, где всем будет интересно и комфортно:</p>
                    <ul>
                        <li>Garden – Зона Garden – это раздолье для движения и творчества маленьких садоводов.</li>
                        <li>Gym – Самое время размяться, стать бодрее и здоровее!</li>
                        <li>Party - Комнаты «До», «Ре», «Ми», «Фа» идеально подходят для детских праздников, юбилеев, встречи выпускников и друзей, празднования годовщины свадьбы, а также проведения конференций, семинаров, мастер-классов и фотосессий.</li>
                        <li>Нашей главной задачей было создать идеальное место для проведения событий разного формата. Универсальный дизайн каждой комнаты позволяет менять её обстановку по вашему вкусу!</li>
                        <li>Наш event-менеджер покажет Вам пространство, предложит удобную рассадку для гостей, ознакомит с меню вкусных блюд и подберет все необходимые услуги для Вашего события.</li>
                        <li>VR – Виртуальные развлечения для всей семьи и друзей.</li>
                    </ul>
                    <p>И теперь у нас всегда хорошая погода, а вместе с ЯРИ всегда ЯРКО!</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(967)446-69-99</p>
