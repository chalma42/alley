        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">X-ONE</h1>
                    <p>Компания является эксклюзивным дистрибьютером бренда X-ONE® в России и СНГ. Мы поставляем качественные, бронированные товары для гаджетов.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(800)707-72-82</p>
