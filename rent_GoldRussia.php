    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/GoldRussia_Back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Золотая Русь</h1>
                    <p>Торговый Дом Золотая Русь осуществляет продажу ювелирных изделий. Золото, серебро, драгоценные камни — от лучших заводов и последних коллекций. У "Золотой Руси" есть и свое ювелирное производство, где изготавливаются эксклюзивные штучные
                        изделия.
                    </p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(924)-443-14-47</p>
