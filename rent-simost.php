    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/Simost_img_1.png">
                <!--Главная фотка-->
                <div class="rent_page_logo">
                    <img src="img1/Logo_Simost.png">
                    <!--Логотип-->
                </div>
            </div>
        </div>
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Магазин страительных материалов "СИМОСТ" </h1>
                    <p>Супермаркет строительных материалов "Симост" предлагает товары для строительства и ремонта:</p>
                    <ul>
                        <li>свежий качественный цемент ПЦ500, ПЦ400 (официальный дилер завода Спасскцемент);</li>
                        <li>сухие строительные смеси Кнауф, ЕК Кемикал, старатели (штукатурка гипсовая Ротбанд, штукатурка цементная, шпатлевка гипсовая, клей для плитки, наливной пол);</li>
                        <li>натуральный гранит разных оттенков;</li>
                        <li>керамогранит глянцевый и матовый в ассортименте;</li>
                        <li>шпаклевка Terraco, праймер Terraco, затирка для кафеля;</li>
                        <li>водоэмульсионная краска Морской конек, Powertex;</li>
                        <li>лакокраска: эмаль, грунтовка;</li>
                        <li>мелкощитовую опалубку;</li>
                        <li>строительные леса: рамного и хомутового типа (продажа и аренда);</li>
                        <li>вышки туры от 4 до 12 метров;</li>
                        <li>вибраторы по бетону, бетоносмесители, строительные тачки;</li>
                        <li>аппараты по резке и загибанию арматуры;</li>
                        <li>металлопрокат: арматура, уголок, швеллер, труба профильная;</li>
                        <li>фиксаторы арматуры, проволоку вязальную;</li>
                        <li>фанеру обычную, ламинированную, осп (osb);</li>
                        <li>сетку фасадную;</li>
                        <li>потолочные панели;</li>
                        <li>базальтовая теплоизоляция Технониколь;</li>
                        <li>экструдированный пенополистирол Европлекс;</li>
                        <li>шпательное стекловолокно;</li>
                        <li>ветро-паро-гидро изоляция Изоспан, Спанлайт;</li>
                        <li>рулонный наплавляемый материал Техноэласт, Биполь, Унифлекс и т.д;</li>
                        <li>битумная мастика, битумный праймер;</li>
                        <li>гипсокартон, гипсоволокнистый лист (ГКЛ, ГВЛ);</li>
                        <li>Кнауф - металлический профиль;</li>
                        <li>метизы;</li>
                        <li>тенты в ассортименте;</li>
                        <li>садовый инструмент, теплицы и парники;</li>
                        <li>электрика (кабеля, автоматы и т д);</li>
                        <li>сантехника (унитазы, ванны, ППР и т д).</li>
                ...
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242) 727-999</p>
                    <p class="time">с 10:00 до 21:00</p>
                </div>
            </div>
            <!--Ниже галерея картинок-->
            <section class="rent_page_gallery">
                <img src="img1/Simost_img_2.png" width="24%">
                <img src="img1/Simost_img_3.png" width="24%">
                <img src="img1/Simost_img_4.png" width="24%">
                <img src="img1/Simost_img_5.png" width="24%">
            </section>
            <br>
            <br>
