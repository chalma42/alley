    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/FourEyes_back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Четыре Глаза</h1>
                    <p>Федеральная сеть магазинов оптической техники "Четыре глаза" (бывший магазин Пират).</p>
                    <p>Телескопы, микроскопы, бинокли, приборы ночного видения, подзорные трубы и прицелы, сверхъяркие светодиодные фонари, средства самозащиты.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)63-92-98</p>
