        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">La Prima</h1>
                    <p>ELa Prima - салон домашнего текстиля: постельное белье, пледы, подушки, одеяла, полотенца, одежда для дома.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)30-26-00</p>
