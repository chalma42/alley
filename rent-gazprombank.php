	...
	<section class="bread" style="padding-top: 26px;">
		<div class="container">
			<ul>
				...
				<li><a href="#">Газпромбанк Банкомат</a></li>
			</ul>
		</div>
	</section>
	<!-- /Bread -->
	...
	<section class="rent_page">
		<div class="rent_page_main">
			<div class="container _anim-items _anim-no-hide">
				<img src="img1/Gazprom_img_1.png"> <!--Главная фотка-->
				<div class="rent_page_logo">
					<img src="img1/Logo_gazprom.png"> <!--Логотип-->
				</div>
			</div>
		</div>
		<div class="container">
			<div class="rent_page_wrapper _anim-items flex">
				<div class="rent_page_desc">
					<h1 class="rent_page_title">Газпромбанк Банкомат </h1>
					<p>В числе клиентов Газпромбанка – около 4 миллионов физических и порядка 45 тысяч юридических лиц.</p>
					<p>В России региональная сеть Газпромбанка представлена 20 филиалами, расположенными от Калининграда до Южно-Сахалинска. Общее число офисов, предоставляющих высококачественные банковские услуги, превышает 350.</p>
					<p>	Газпромбанк является членом Российского национального комитета Международной торговой палаты.</p>
					<p>Генеральная лицензия Банка России на осуществление банковских операций № 354 от 29.12.2014.</p>
					<ul>
