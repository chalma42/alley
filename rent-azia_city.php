	...
	<section class="rent_page">
		<div class="rent_page_main">
			<div class="container _anim-items _anim-no-hide">
				<img src="img1/Azia_city_img_1.png"> <!--Главная фотка-->
				<div class="rent_page_logo">
					<img src="img1/Logo_azia_city.png"> <!--Логотип-->
				</div>
			</div>
		</div>
		<div class="container">
			<div class="rent_page_wrapper _anim-items flex">
				<div class="rent_page_desc">
					<h1 class="rent_page_title">Азия Сити товары из Кореи</h1>
					<p>Азия Сити - сеть магазинов с хозяйственно-бытовыми товарами из Южной Кореи</p>
					<ul>
			...
			<section class="rent_page_gallery _anim-items">
				<img src="img1/Azia_city_img_2.png" width="24%">
				<img src="img1/Azia_city_img_3.png" width="24%">
				<img src="img1/Azia_city_img_4.png" width="24%">
				<img src="img1/Azia_city_img_5.png" width="24%">
			</section>
			<br>
			<br>
