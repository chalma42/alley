    ...
    <section class="bread" style="padding-top: 26px;">
        <div class="container">
            <ul>
                ...
                <li><a href="#">Золотой Теленок</a></li>
            </ul>
        </div>
    </section>
    <!-- /Bread -->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Золотой Теленок</h1>
                    <p>Сеть фирменных магазинов по продаже мясной продукции производства СМПФ "Золотой теленок".</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(4242)30-10-78</p>
