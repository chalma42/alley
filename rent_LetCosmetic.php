    ...
    <section class="bread" style="padding-top: 26px;">
        <div class="container">
            <ul>
                ...
                <li><a href="#">Letique Cosmetics</a></li>
            </ul>
        </div>
    </section>
    <!-- /Bread -->
    ...
    <section class="rent_page">
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/LetCosmetic_back.png">
                <!--Главная фотка-->
        ...
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Letique Cosmetics</h1>
                    <p>Бренд, поставивший перед собой задачу создать продукты самого высокого качества по честной цене. При поддержке команды профессиональных косметологов нам удалось воплотить её мечты в жизнь, и мы с гордостью представляем вам свою продукцию.
                        При разработке линейки средств по уходу за телом мы соединили успешные классические рецепты и оригинальные современные разработки. В составе наших продуктов только самые качественные ингредиенты! Мы выступаем за этичное отношение
                        к животным! Никто не должен страдать ради того, чтобы наши средства работали. Поэтому вся косметика Letique создаётся без тестов на животных.</p>
                    <p>Наша продукция отвечает всем требованиям качества и эффективно ухаживает за кожей. Это — та самая косметика, которой хочет пользоваться каждая девушка: доступная, качественная, безопасная и эффективная. Мы создаём и предлагаем вам
                        тот продукт, в котором уверены, и которым искренне гордимся. Потому что мы предлагаем вам только самое лучшее.</p>
                </div>
                <div class="rent_page_contacts">
                    ...
                    <p class="phone">8(800)777-45-90</p>
