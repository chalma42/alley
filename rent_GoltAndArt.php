    ...
    <section class="rent_page">
        ...
        <div class="rent_page_main">
            <div class="container _anim-items _anim-no-hide">
                <img src="img1/Svyaznoi_img_1.png">
                <!--Главная фотка-->
                <div class="rent_page_logo">
                    <img src="img1/Logo_svyaznoi.png">
                    <!--Логотип-->
                </div>
            </div>
        </div>
        <div class="container">
            <div class="rent_page_wrapper _anim-items flex">
                <div class="rent_page_desc">
                    <h1 class="rent_page_title">Gold and Art</h1>
                    ...
                    <p>"Gold&Art" - является официально зарегистрированным товарным знаком. Магазины "Gold&Art" осуществляют розничную торговлю ювелирными изделиями из драгоценных металлов, часами российского и швейцарского производства, а также другой ювелирной
                        продукцией.
                    </p>
                </div>
